...
class SeaReader_v5(torch.nn.Module):
    ...
    def forward(self, contents, question_ans, logics, contents_char=None, question_ans_char=None):
        ...
        # viewed_reasoning_question_gating_val = torch.stack([reasoning_question_gating_val for i in range(self.use_content_nums)],dim=1).view(batch_size*self.use_content_nums,max_question_len,1) # size 16*n,100,1
